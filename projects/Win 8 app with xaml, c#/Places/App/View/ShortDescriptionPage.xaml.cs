...
namespace App.View
{
    ...
    /// </summary>
    public sealed partial class ShortDescriptionPage : Page
    {
        public ShortDescriptionPage()
        {
        ...
        private void NavigateToAssociet(object sender, ItemClickEventArgs e)
        {
            ShortDescriptionViewModel.SelectedElement = (e.ClickedItem as WelcomePlace);
            (this.DataContext as ShortDescriptionViewModel).NavigateCommand.Execute(null);
        }
    }
}
