...
namespace App.View
{
    ...
    /// </summary>
    public sealed partial class AssociatesByContinent : Page
    {
        public AssociatesByContinent()
        {
        ...
        private void NavigateToShortDescriptionPage(object sender, ItemClickEventArgs e)
        {
            ...
            (this.DataContext as AssociatesByContinentViewModel).NavigateCommand.Execute(null);
        }
    }
}
